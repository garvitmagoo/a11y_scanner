  ...
  return (
    <div className="test-container">
      ...
      <section>
        ...
        <div role="invalid-role">This has an invalid role</div>

        {/* FAIL: Invalid role value */}
        <div role="superbutton">Custom button</div>
      ...
      <section>
        ...
        <span onClick={() => setIsOpen(!isOpen)}>Toggle menu</span>
        ...
        <button onClick={() => console.log("clicked")}>Native button</button>
      </section>
      ...
      <section>
        ...
        <label htmlFor="proper-field">Email (required)</label>
        <input id="proper-field" type="email" required aria-required="true" />
